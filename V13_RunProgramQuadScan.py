...
from V13_Functions import MultipleHeatMapPlot
...
##############################################################################
#Phase 2 Macro
sinograms = np.loadtxt('XdataMacroPhase2.txt',delimiter=',')
opticsParams = np.loadtxt('YdataMacroPhase2.txt',delimiter=',')
tag ='Phase2'
##############################################################################
...
if LoadModel:
    ...
    linear_model.save("my_model"+tag)
