# -*- coding: utf-8 -*-
"""
Created on Thu Aug  5 18:33:38 2021
...
#opticsParams = np.loadtxt('MATLABTrainingDataY.txt',delimiter=',') #For MATLAB Data
opticsParams = np.loadtxt('Ydata.txt',delimiter=',') #For Python Data

#sinograms = np.loadtxt('MATLABTrainingDataX.txt',delimiter=','); #For MATLAB Data
